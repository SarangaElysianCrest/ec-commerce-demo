...
const AuthViewLogin  = ({onLogin,onLoginWithGoogle,onLoginWithFacebook,onSignup,onConfirmSignup,onSendPasswordResetCode,onVerifyPasswordResetCode,onCreateUser}) =>{
    ...
    const handleSignup = (e) => {
        ...
        let email = data.get('email');
        let password = data.get('password');
        let confPassword = data.get('confPassword');
